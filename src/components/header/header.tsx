...
function Header() {
    ...
    // Scroll listener for sticky header height & shadow effects
    useEffect(() => {
        const handleScroll = () => {
        ...
        <header className={`header ${isScrolled ? 'header-scrolled' : ''}`}>
            <div className="header-container">
                ...
                >
                    ...
                    <div className="logo-text-wrapper">
                        ...
                        <span className="logo-subtitle">Psicóloga Clínica</span>
                    </div>
                </a>
                ...
                <nav className="desktop-nav" aria-label="Navegação principal">
                    ...
                    <a href="#abordagem" className="nav-link">Abordagem & Clínica</a>
            ...
            >
                ...
                <nav className="mobile-nav">
                    ...
                    <a href="#sobre" className="mobile-nav-link" onClick={closeMenu}>
                        <svg className="nav-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    ...
                    <a href="#abordagem" className="mobile-nav-link" onClick={closeMenu}>
                        <svg className="nav-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                ...
                <div className="mobile-drawer-footer">
                    <a href="#agendar" className="mobile-cta-button" onClick={closeMenu}>
